...
def update_output_container(input_year, selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        ...
        yrdata = recession_data[recession_data['Year']==input_year]
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,
                                x='Vehicle_Type',
                                y='Automobile_Sales',
                                title="Average Vehicles sold by vehicle types"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(recession_data,
                            x='unemployment_rate',
                            y=['Vehicle_Type','Automobile_Sales'],
                            title='unemployment effect on vehicle type and vehicle sales'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        y_r_data = yearly_data[region_data['Year']==input_year]
        avr_vdata=y_r_data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,x='Vehicle_Type',
